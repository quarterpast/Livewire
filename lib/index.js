(function(){
  ...
  function app(req, res){
    ...
    return sync(function(){
      var augs, fns, res$, i$, ref$, len$, route, e;
      try {
        augs = {
          req: Request(req),
          res: Response(res)
        ...
        for (i$ = 0, len$ = (ref$ = Router.route(req)).length; i$ < len$; ++i$) {
          route = ref$[i$];
          res$.push((fn$.call(this$, augs.req, res, route)));
        }
        fns = res$;
        return function(it){
        ...
        fold(curry$(function(x$, y$){
          return x$(y$);
        }), "404 " + augs.req.pathname)(
        fns)));
      } catch (e$) {
        e = e$;
        return Router.error(augs.res, e);
      }
      function fn$(req, res, route){
        import$(augs.req.params, route.extract(augs.req));
        return function(it){
          return route.func.sync(augs.req, augs.res, it);
        };
      }
    });
  }
